...
public class ViewPagerActivity extends Activity {
	...
	static class SamplePagerAdapter extends PagerAdapter {
		...
		private static final int[] sDrawables = { R.drawable.img_default, R.drawable.img_default, R.drawable.img_default,
				R.drawable.img_default, R.drawable.img_default, R.drawable.img_default };
